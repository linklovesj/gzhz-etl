    ...
    public static  class SqlHelper3
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper3._con == null)  
                {
                    SqlHelper3._con = new OracleConnection();  
                }
                if (SqlHelper3._con.ConnectionString == null || SqlHelper3._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper3._con.ConnectionString = SqlHelper3.constr;
                }
                return SqlHelper3._con;  
            }  
            set  
            {  
                SqlHelper3._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper3.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper3.Con.State != ConnectionState.Closed)
                {
                    SqlHelper3.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper3.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper3.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper3._assemblyName).CreateInstance(SqlHelper3._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper3.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper3.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
