...
{
    public static  class SqlHelper8
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper8._con == null)  
                {
                    SqlHelper8._con = new OracleConnection();  
                }
                if (SqlHelper8._con.ConnectionString == null || SqlHelper8._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper8._con.ConnectionString = SqlHelper8.constr;
                }
                return SqlHelper8._con;  
            }  
            set  
            {  
                SqlHelper8._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper8.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper8.Con.State != ConnectionState.Closed)
                {
                    SqlHelper8.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper8.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper8.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper8._assemblyName).CreateInstance(SqlHelper8._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper8.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper8.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
