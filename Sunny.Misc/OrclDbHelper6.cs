...
{
    public static  class SqlHelper6
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper6._con == null)  
                {
                    SqlHelper6._con = new OracleConnection();  
                }
                if (SqlHelper6._con.ConnectionString == null || SqlHelper6._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper6._con.ConnectionString = SqlHelper6.constr;
                }
                return SqlHelper6._con;  
            }  
            set  
            {  
                SqlHelper6._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper6.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper6.Con.State != ConnectionState.Closed)
                {
                    SqlHelper6.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper6.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper6.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper6._assemblyName).CreateInstance(SqlHelper6._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper6.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper6.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
