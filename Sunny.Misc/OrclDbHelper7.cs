...
{
    public static  class SqlHelper7
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper7._con == null)  
                {
                    SqlHelper7._con = new OracleConnection();  
                }
                if (SqlHelper7._con.ConnectionString == null || SqlHelper7._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper7._con.ConnectionString = SqlHelper7.constr;
                }
                return SqlHelper7._con;  
            }  
            set  
            {  
                SqlHelper7._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper7.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper7.Con.State != ConnectionState.Closed)
                {
                    SqlHelper7.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper7.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper7.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper7._assemblyName).CreateInstance(SqlHelper7._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper7.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper7.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
