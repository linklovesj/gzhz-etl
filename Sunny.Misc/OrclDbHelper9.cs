    ...
    public static  class SqlHelper9
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper9._con == null)  
                {
                    SqlHelper9._con = new OracleConnection();  
                }
                if (SqlHelper9._con.ConnectionString == null || SqlHelper9._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper9._con.ConnectionString = SqlHelper9.constr;
                }
                return SqlHelper9._con;  
            }  
            set  
            {  
                SqlHelper9._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper9.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper9.Con.State != ConnectionState.Closed)
                {
                    SqlHelper9.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper9.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper9.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper9._assemblyName).CreateInstance(SqlHelper9._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper9.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper9.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
