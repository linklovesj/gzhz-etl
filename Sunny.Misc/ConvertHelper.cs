...
namespace Sunny.Misc
{
    ...
    public class ConvertHelper
    {
        ...
        public static string RepairZero(string text, int limitedLength, bool bIsAddPrefix = true)
        {
            //补足0的字符串
            string temp = "";
        ...
        public static double ToDouble(object data)
        {
            ...
            {
                //如果为空则返回0
                if (ValidationHelper.IsNullOrEmpty(data) || data.ToString().ToUpper() == "NULL")
                {
                    return 0;
                }
                else
        ...
        public static double ToDouble(object data, int decimals)
        {
            ...
            {
                //如果为空则返回0
                if (ValidationHelper.IsNullOrEmpty<object>(data) || data.ToString().ToUpper() == "NULL")
                {
                    return 0;
                }
                else
        ...
        */
        ...
        /// <param name="iEffectiveNum">有效数字位数</param>
        /// <returns></returns>
        public static double ToEffectiveNumber(object data, int iEffectiveNum)
        {
            try
            {
                //如果为空则返回0
                ...
                {
                    double temp = Convert.ToDouble(data);
                    return Convert.ToDouble(temp.ToString("G" + iEffectiveNum.ToString()));
                }
            }
            catch
            {
        ...
        /// <param name="iEffectiveNum">有效数字位数</param>
        /// <returns></returns>
        public static double ToEffectiveNumber(double data, int iEffectiveNum)
        {
            try
            {
                //如果为空则返回0
                ...
                {
                    return Convert.ToDouble(data.ToString("G" + iEffectiveNum.ToString()));
                }
            }
            catch
            {
        ...
        /// 转换成流量数据格式
        /// </summary>
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToQ(object data)
        {
            return ToEffectiveNumber(data, 3);
        }
        ...
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToQ(double data)
        {
            double dQ = ToEffectiveNumber(data, 3);
            return Math.Abs(dQ) < 0.001 ? 0 : dQ;
        }
        #endregion
        ...
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToZ(object data)
        {
            return ToDouble(data, 2);
        }
        #endregion

        #region 雨量、降水量，保留1位小数
        /// <summary>
        /// 转换成雨量数据格式
        /// </summary>
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToP(object data)
        {
        ...
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToE(object data)
        {
            return ToDouble(data, 1);
        }
        #endregion

        #region 库容、蓄水量，保留3位有效数字
        /// <summary>
        /// 转换成库容、蓄水量数据格式
        /// </summary>
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToV(object data)
        {
            return ToEffectiveNumber(data, 3);
        }
        #endregion
        ...
        /// <param name="data">待转换值</param>
        /// <returns></returns>
        public static double ToW(object data)
        {
            return ToEffectiveNumber(data, 4);
        }
        #endregion

        #region 判断两个double值是否相等
        /// <summary>
        /// 判断两个double值是否相等
        /// </summary>
        ...
        /// <returns></returns>
        public static bool IsDoubleEqual(double val1, double val2)
        {
        ...
        /// <summary>
        /// 将List转化成'STCD1','STCD2',...的格式字符串
        /// </summary>
        /// <param name="lstIds">Id列表</param>
        /// <param name="isAddQuotes">转换后的字符是否需要加引号</param>
        /// <param name="splitChar">各字符之间的分隔符，默认为逗号</param>
        /// <returns></returns>
        public static string GetStringByList(List<string> lstIds, bool isAddQuotes = true, char splitChar = ',')
        {
            if (lstIds == null || lstIds.Count <= 0) return "";

            StringBuilder sbSTCDs = new StringBuilder(lstIds.Count * 16);
            foreach (var item in lstIds)
            {
                sbSTCDs.AppendFormat("{1}{0}{1}{2}", item, isAddQuotes ? "'" : "", splitChar);
            }
            return sbSTCDs.ToString().TrimEnd(splitChar);
        }
    }
}
