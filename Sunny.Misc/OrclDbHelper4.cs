...
{
    public static  class SqlHelper4
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper4._con == null)  
                {
                    SqlHelper4._con = new OracleConnection();  
                }
                if (SqlHelper4._con.ConnectionString == null || SqlHelper4._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper4._con.ConnectionString = SqlHelper4.constr;
                }
                return SqlHelper4._con;  
            }  
            set  
            {  
                SqlHelper4._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper4.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper4.Con.State != ConnectionState.Closed)
                {
                    SqlHelper4.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper4.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper4.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper4._assemblyName).CreateInstance(SqlHelper4._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper4.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper4.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
