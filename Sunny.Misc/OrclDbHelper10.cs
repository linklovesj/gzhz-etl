...
{
    public static  class SqlHelper10
    {
        ...
        public static OracleConnection Con  
        {
            get  
            {
                ...
                if (SqlHelper10._con == null)  
                {
                    SqlHelper10._con = new OracleConnection();  
                }
                if (SqlHelper10._con.ConnectionString == null || SqlHelper10._con.ConnectionString.Equals(string.Empty))
                {
                    SqlHelper10._con.ConnectionString = SqlHelper10.constr;
                }
                return SqlHelper10._con;  
            }  
            set  
            {  
                SqlHelper10._con = value;  
            }  
        }  
        #endregion  
        ...
        {   
            int result = 0;  
            try{
                using (OracleCommand cmd = new OracleCommand(commandText, SqlHelper10.Con))  
                {  
                    try  
                    {  
            ...
            {
                if (SqlHelper10.Con.State != ConnectionState.Closed)
                {
                    SqlHelper10.Con.Close();
                }
            }
            return result;
        }
            ...
            try
            {
                ...
                {  
                    ...
                    {  
                        ...
                        if (SqlHelper10.Con.State!=ConnectionState.Open)
                        {
                           SqlHelper10.Con.Open();  
                        }
        ...
        {    
            ...
            {  
                ...
                //obj = (T)Assembly.Load(SqlHelper10._assemblyName).CreateInstance(SqlHelper10._assemblyName + "." + type.Name);//从另一个程序集里面通过反射的方式创建指定类型的对象
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    while (reader.Read())  
                    {  
                        obj = SqlHelper10.ExecuteDataReader<T>(reader);  
                    }  
                }  
            }
            finally
            ...
            {  
                ...
                {  
                    ...
                    {  
                        ...
                        while (reader.Read())  
                        {  
                            T obj = SqlHelper10.ExecuteDataReader<T>(reader);  
                            list.Add(obj);  
                        }  
                    }  
                    catch (Exception ex)  
